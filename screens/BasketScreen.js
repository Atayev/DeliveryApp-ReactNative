  ...
  return (
    <SafeAreaView className="flex-1 bg-white py-5">
      <View className="flex-1 bg-gray-100">
        <View className="p-5 border-b border-[#1874d2] bg-white shadow-xs">
          <View>
          ...
          >
            <XCircleIcon color="#1874d2" size={50} />
          </TouchableOpacity>
        </View>
        <View className="flex-row items-center space-x-4 px-4 py-3 bg-white my-5">
          ...
          <TouchableOpacity>
            <Text className="text-[#1874d2]">Change</Text>
          </TouchableOpacity>
        </View>
        <ScrollView className="divide-y divide-gray-200">
          {Object.entries(groupedItems).map(([key, items]) => (
            ...
            >
              <Text className="text-[#1874d2]">{items.length} x</Text>
              <Image
        ...
        <View className="p-5 bg-white mt-5 space-y-4">
          ...
          <TouchableOpacity
            ...
            className="rounded-lg bg-[#1874d2] p-4"
          >
